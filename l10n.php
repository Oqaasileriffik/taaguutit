...
$gdocs = [
	...
	'https://docs.google.com/spreadsheets/d/1igZfIBa2NeJh61XuoUGdvV4FHHkwTGfeIxnSUAmNRes/export?exportFormat=csv', // Dictionary
	'https://docs.google.com/spreadsheets/d/14Z9jkhF6V7fV-j5MXbVxFUJ-O2YRACf-g3-TCkNiif8/export?exportFormat=csv', // Taaguutit
	];
...
foreach ($keys as $k) {
	...
	if (strpos($used, "data-l10n=\"$k\"") !== false || strpos($used, "data-l10n-alt=\"$k\"") !== false || strpos($used, "data-l10n-href=\"$k\"") !== false || strpos($used, "data-l10n-placeholder=\"$k\"") !== false) {
		$js[$k] = $k;
		$hit = true;
	}
